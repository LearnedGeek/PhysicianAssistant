# DrOk Platform — Preliminary Term Sheet
**For Discussion Purposes Only — Non-Binding**
...
**Learned Geek LLC** ("Platform Provider") — Mark McArthey, Wisconsin, USA
**Dr. Martín Núñez** ("Brand Partner") — Lima, Peru
...
- Security, compliance, uptime, and infrastructure
- Feature development and technical support
- Carrying appropriate professional liability and cyber insurance

**Dr. Martín Núñez is responsible for:**
- Selling DrOk subscriptions to physicians
...
| Milestone | Payment |
|---|---|
| Engagement letter signed / Discovery complete | $3,500 |
| Phase 2 complete (Infanzia product chatbot) | $5,000 |
| Phase 3 complete (physician system backend) | $5,000 |
| Phase 4 complete (physician dashboard + go-live) | $4,000 |
| **Total upfront** | **$17,500** |

*Exact amounts subject to Discovery scoping. Milestone structure protects both parties — Martin pays for delivered work; Learned Geek is not building at full risk.*
...
| Revenue Type | Learned Geek | Martin (DrOk) | Rationale |
|---|---|---|---|
| Monthly per-physician platform fee | 60% | 40% | Learned Geek carries ongoing hosting, maintenance, support, and insurance |
| One-time physician onboarding fee | 20% | 80% | Onboarding is Martin's sales and relationship effort |
| Future B2C parent subscriptions | 40% | 60% | Martin is the clinical face parents trust |

**Suggested physician platform fee (Martin sets his own price):** Learned Geek's floor is $X/physician/month. Martin may charge physicians whatever the market supports above that floor — the difference is his margin.

*Floor pricing to be agreed during Discovery based on infrastructure cost modeling.*
...
- Good-faith sales and marketing effort throughout the exclusivity period

*If minimums are not met, exclusivity converts to non-exclusive. This is not a penalty — it protects both parties from a dormant exclusive arrangement.*
...
6. Engagement letter drafted based on aligned terms

---

*This document is for discussion purposes only and does not constitute a binding agreement. All terms are subject to negotiation and final execution of a formal engagement agreement reviewed by legal counsel for both parties.*
